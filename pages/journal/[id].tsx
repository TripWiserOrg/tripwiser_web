  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`https://tripwiser-web-lmgo.vercel.app/journal/${tripId}`} />
        ...
        <meta property="twitter:url" content={`https://tripwiser-web-lmgo.vercel.app/journal/${tripId}`} />
