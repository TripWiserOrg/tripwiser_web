  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`https://tripwiser-web-lmgo.vercel.app/discover/post/${postId}`} />
        ...
        <meta property="twitter:url" content={`https://tripwiser-web-lmgo.vercel.app/discover/post/${postId}`} />
